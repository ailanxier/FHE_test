...
int main(int argc, char **argv){
    ...
    std::ifstream helib_server_ifile(server_recv_fileName, std::fstream::in);
    ...
    // 保存结果密文到文件
    std::ofstream helib_server_ofile(server_result_filename, std::fstream::out | std::fstream::trunc);
